    ...
    <>
      <section className="bg-stone-50 py-24 sm:py-32">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <h2 className="text-base font-semibold leading-7 text-violet-800">
            Overview
          </h2>
          ...
          >
            <button
              type="button"
              className="text-neutral-50 bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:ring-violet-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
            >
              웹사이트 보러가기
            </button>
          </a>
      ...
      <section className="bg-neutral-100 py-20 sm:py-16">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <ol className="items-start sm:flex w-full">
            <li className="relative mb-6 sm:mb-0 w-full cursor-pointer hover:text-violet-700">
              <div className="flex items-center">
                <div className="z-10 flex items-center justify-center w-6 h-6 bg-violet-100 rounded-full shrink-0">
                  1
                </div>
              ...
              <div className="mt-3 sm:pe-8">
                ...
                <p
                  className="text-base font-normal text-gray-500 hover:text-violet-700"
            ...
            <li className="relative mb-6 sm:mb-0 w-full cursor-pointer">
              <div className="flex items-center">
                <div className="z-10 flex items-center justify-center w-6 h-6 bg-violet-100 rounded-full shrink-0">
                  2
                </div>
            ...
            <li
              className="relative mb-6 sm:mb-0 w-full cursor-pointer hover:text-violet-700"
            ...
            >
              ...
              <div className="mt-3 sm:pe-8">
                <h3 className="text-lg font-semibold text-gray-900 hover:text-violet-700">
                  Test
                </h3>
                <p className="text-base font-normal text-gray-500">
                  <span
      ...
      <section
        ...
        className="bg-neutral-50 py-20 sm:py-16"
      >
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
      ...
      <section ref={initialDesignRef} className="bg-neutral-50 py-20 sm:py-16">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="flex items-center space-x-4">
            <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-2xl">
              Initial Design
      ...
      <section ref={hiFiPrototypeRef} className="bg-neutral-50 py-20 sm:py-16">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="flex items-center space-x-4">
            <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-2xl">
              Hi-fi Prototype
      ...
      <section ref={aiIntegrationRef} className="bg-neutral-50 py-20 sm:py-16">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="flex items-center space-x-4">
            <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-2xl">
              AI Integration
